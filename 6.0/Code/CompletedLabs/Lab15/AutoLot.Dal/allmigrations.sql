...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20211106191245_Initial')
BEGIN
...
BEGIN
    ...
    VALUES (N'20211106191245_Initial', N'6.0.5');
END;
GO
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20211106200541_CustomSql')
BEGIN
    exec (N' 
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20211106200541_CustomSql', N'6.0.5');
END;
GO
